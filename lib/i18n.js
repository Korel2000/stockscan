...
const DICT = {
  he: {
    ...
    quoteTitle: 'ציטוט Level 1', quoteLoading: 'טוען נתונים...', quoteError: 'שגיאה בטעינת הציטוט',
    bidLabel: 'ביד (קנייה)', askLabel: 'אסק (מכירה)', spreadLabel: 'מרווח', sharesLabel: 'מניות',
    quoteDemoNote: 'נתוני דמו סינתטיים לצורך תצוגה מקדימה — לא מחירי שוק אמיתיים',
    bidJumpTitle: '⚡ קפיצת ביד', bidJumpBody: '{symbol} קפץ ל-${price}',
    connectGoogleBtn: 'התחבר עם Google', connectError: 'שגיאה בחיבור החשבון',
    shortcutAccountsSub: 'נהל את חשבונות המסחר שלך', shortcutAssistantSub: 'שאל שאלות על המסחר שלך',
    tipTitle: 'טיפ מהיר?', tipBody: 'ייבוא CSV מהברוקר שלך יכול לחסוך לך זמן רב על הזנת טריידים ידנית.',
    pushUnsupported: 'הדפדפן לא תומך', pushFallbackNote: 'הדפדפן לא תומך בהתראות Push — תמשיך לקבל התראות בתוך האפליקציה כל עוד היא פתוחה',
    aboutTitle: 'אודות החברה', sectorLabel: 'ענף', revenueLabel: 'הכנסות', netIncomeLabel: 'רווח נקי',
    debtEquityLabel: 'חוב/הון', fcfLabel: 'תזרים חופשי', aiSummaryBtn: 'סיכום מנהלים AI'
  },
  en: {
    ...
    quoteTitle: 'Level 1 Quote', quoteLoading: 'Loading data...', quoteError: 'Error loading quote',
    bidLabel: 'Bid', askLabel: 'Ask', spreadLabel: 'Spread', sharesLabel: 'shares',
    quoteDemoNote: 'Synthetic demo data for preview purposes — not real market prices',
    bidJumpTitle: '⚡ Bid Jump', bidJumpBody: '{symbol} jumped to ${price}',
    connectGoogleBtn: 'Connect with Google', connectError: 'Error connecting account',
    shortcutAccountsSub: 'Manage your trading accounts', shortcutAssistantSub: 'Ask questions about your trading',
    tipTitle: 'Quick tip?', tipBody: 'Importing a CSV from your broker can save you a lot of time versus entering trades manually.',
    pushUnsupported: 'Not supported', pushFallbackNote: "Your browser doesn't support Push — you'll still get alerts inside the app as long as it stays open",
    aboutTitle: 'About the Company', sectorLabel: 'Sector', revenueLabel: 'Revenue', netIncomeLabel: 'Net Income',
    debtEquityLabel: 'Debt/Equity', fcfLabel: 'Free Cash Flow', aiSummaryBtn: 'AI Executive Summary'
  }
};
