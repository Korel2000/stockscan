...
const DICT = {
  he: {
    ...
    signOut: 'התנתקות', noActiveAccount: 'אין חשבון פעיל', accountSettings: 'חשבון · לכי להגדרות ⚙',
    ...
    scan: 'סרוק', enablePush: '🔔 הפע� התראות פוש', pushActive: '✓ התראות פעילות', pushDenied: 'ההרשאה.�נדחתה',
